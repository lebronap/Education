...
public class ClassInfoAdapter extends BaseAdapter{
    ...
    public ClassInfoAdapter(Context context, List<Map<String, Object>> data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ClassInfoAdapter.ViewHolder viewHolder = null;
        if (viewHolder == null){
            viewHolder = new ClassInfoAdapter.ViewHolder();
            ...
            viewHolder = (ClassInfoAdapter.ViewHolder)convertView.getTag();
        }
